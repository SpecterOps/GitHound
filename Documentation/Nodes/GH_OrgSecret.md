# <img src="../images/GH_OrgSecret.png" width="50"/> GH_OrgSecret
...
| GH_HasSecret | GH_Repository   | No          | Repository has access to this organization secret (resolved by visibility). |
