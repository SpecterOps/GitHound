...
| --------------------------------------------------------------------------------------- | ------------------------------------------------------- | ----------- | --------------------------------------------------------------------- |
| [GH_MemberOf](../EdgeDescriptions/GH_MemberOf.md)                                       | GH_Team                                                 | Yes         | Team is a child of a parent team.                                     |
...
| [GH_MemberOf](../EdgeDescriptions/GH_MemberOf.md) | GH_Team                         | Yes         | A child team is a member of this team.                |
