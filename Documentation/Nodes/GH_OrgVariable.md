# <img src="../images/GH_OrgVariable.png" width="50"/> GH_OrgVariable
...
| -------------- | --------------- | ----------- | ------------------------------------------------------------------------------ |
| GH_Contains    | GH_Organization | No          | Organization contains this variable.                                           |
| GH_HasVariable | GH_Repository   | No          | Repository has access to this organization variable (resolved by visibility). Non-traversable because variables are non-sensitive configuration values. |
